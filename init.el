...
(use-package general
  ...
  (efs/leader-keys
    ...
    "b" '(gud-break :which-key "insert break point")
    "8" '(gud-next :which-key "move to next line")
    "7" '(gud-step :which-key "step into line")
    "9" '(gud-go :which-key "continue execution")
